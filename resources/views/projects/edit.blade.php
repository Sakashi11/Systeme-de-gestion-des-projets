...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800">
            <i class="fas fa-edit mr-2 text-blue-700"></i>Modifier le Projet
        </h1>
    </div>
        ...
        <form method="POST" action="/projects/{{ $project->id }}">
            ...
            <div class="mb-4">
                ...
                <textarea
                    name="description"
                    rows="3"
                    class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:border-blue-500">{{ old('description', $project->description) }}</textarea>
            </div>
