...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center mb-6">
        <a href="/admin/members" class="text-blue-700 hover:underline mr-4">
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form method="POST" action="/admin/members">
            ...
            <div class="flex gap-4">
                ...
                <a href="/admin/members" class="bg-gray-200 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-300">
                    Annuler
                </a>
            </div>
        </form>
